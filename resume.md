...
## Experience
### Oracle
##### Senior Infrastructure & System Engineer (OCI/Linux), May 2022 - Present, Remote, México
Leading the automation strategy for SmartNIC Lifecycle Management on Oracle Linux, bridging the gap between hardware provisioning and cloud-scale OS reliability.
...
### Lenovo
##### Test & Systems Infrastructure Engineer, August 2019 - February 2022, Nuevo León, México
Engineered automation solutions for high-volume manufacturing environments, focusing on large-scale infrastructure provisioning and system reliability.
...
### Kärcher
##### Test Engineering Intern (NPI), January 2019 - July 2019, Nuevo León, México
Supported the product lifecycle by automated hardware-software interaction environments for New Product Introduction (NPI), serving as a technical bridge between Design and Manufacturing engineering teams.
...
**Degree:** B.S. Mechatronics Engineer | **Years Attended:** 2014 - 2019 | **State, Country:** Nuevo León, México
