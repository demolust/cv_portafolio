const data = {
  "personalInfo": {
    ...
    "jobTitle": "Senior System Automation Engineer (Linux)",
    "profileImage": "assets/images/resume-profile.png",
    "summary": "Results-driven System Automation Engineer with 6+ years of experience driving growth through innovative solutions developing system-level tools and automated solutions, that typically include Python-based automation tools, Infrastructure as Code (IaC) via Ansible/Terraform, CI/CD pipelines, Shell-based tools\nProven track record in designing, developing, and maintaining Python-based automation frameworks for complex systems\nMigrating legacy workflows to Infrastructure as Code (IaC) using Ansible and Terraform\nExpert in architecting CI/CD pipelines for validating, building, testing, and deploying code\nExpert in designing test automation frameworks that help reduced QA cycles by up to 80% as proven on Oracle Linux on SmartNIC systems\nProficient in Linux System Administration, IaC, Python, Bash, SQL, with a focus on building CLI/TUI applications and internal infrastructure platforms",
    "email": "***REMOVED***",
    "phone": "***REMOVED***",
    "location": "Nuevo León",
    "github": {
      ...
      "items": [
        ...
        },
        {
          ...
          "key_acomplishments": [
            ...
            "Engineered a Python-based SFTP client/server system to enable secure, controlled data exchange within the internal network",
            "Designed and implemented logic for an accessory-tracking system that utilized SQL DBs to automate manufacturing quality checks",
            "Automated PXE OS provisioning for manufacturing host machines, ensuring high-speed, reliable, and repeatable installations",
            "Managed and automated configurations for network switches and Linux/Windows host administration"
          ]
        },
        {
          ...
          "position_summary": "Supported the QA lifecycle by automating hardware-software interaction environments to simulate product functionality during the NPI phase\nFocused on ensuring product reliability through manual & automated functional testing and data-driven quality reporting",
          "key_acomplishments": [
            "Designed and implemented a LabVIEW-based automated test suite to simulate real-world product functionality for the NPI product",
            "Conducted CAE analysis on CAD designs to identify potential flaws, ensuring high-quality standards before manufacturing deployment",
            ...
            "Performed both manual and automated QA testing, collecting data to generate validation reports for Design and QA teams"
          ]
        }
      ]
    },
